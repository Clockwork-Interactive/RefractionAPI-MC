...
public class RDashboard extends TabbedScreen {
    ...
    protected void initTabs() {
        ...
        for (String renderer : RDebugRenderer.getRenderers()) {
            debuggers.addCheckbox(Component.literal(renderer.toUpperCase(Locale.ROOT)), 100, RDebugRenderer.isEnabled(renderer), (checkbox1 -> RDebugRenderer.toggle(renderer))).setPadding(5, 0, 0, 5);
        }
