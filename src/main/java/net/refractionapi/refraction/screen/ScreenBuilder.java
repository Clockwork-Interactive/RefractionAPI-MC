...
public class ScreenBuilder<T extends ServerScreen> {
    ...
    public static class Builder {
        ...
        public ScreenBuilder.Builder clientScreenCreator(Function<Object[], Object> clientScreenCreator) {
            this.clientScreenCreator = clientScreenCreator;
            return this;
        }

        public ScreenBuilder.Builder deserializer(Function<CompoundTag, Object[]> deserializer) {
            this.deserializer = deserializer;
            return this;
        }

        public ScreenBuilder.Builder serializer(Function<Object[], CompoundTag> serializer) {
            this.serializer = serializer;
            return this;
        }

        public ScreenBuilder.Builder serverHandler(BiConsumer<ServerScreen, CompoundTag> serverHandler) {
            this.serverHandler = serverHandler;
            return this;
        }

        public ScreenBuilder.Builder serverScreenCreator(Function<ServerPlayer, ServerScreen> serverScreenCreator) {
            this.serverScreenCreator = serverScreenCreator;
            return this;
        }
