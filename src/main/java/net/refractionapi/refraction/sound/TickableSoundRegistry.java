...
public class TickableSoundRegistry {
    ...
    public static void attach(String sound, LivingEntity living, CompoundTag tag, String cacheName) {
        ...
        try {
            soundInstance = (DeserializedSound) soundEntry.sound.getConstructor(LivingEntity.class, CompoundTag.class).newInstance(living, tag);
        } catch (Exception e) {
